...
"""Launch paired Wilcoxon analysis for a sorted extended_exp2 campaign."""
...
def generate_launch_description():
    """Configure the paired analysis node from a sorted extended_exp2 campaign."""
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            ...
            description='Directory with run_idx-sorted CSVs for '
                        'extended_exp2, e.g. the sort_results.py --output '
                        'directory or a batch campaigns/extended_exp2/sorted/ '
                        'directory'),
        DeclareLaunchArgument(
